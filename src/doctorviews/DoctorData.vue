<template>
    <div id="DoctorDate">
        <el-form ref="form"  label-width="80px">
            ...
            <el-col :span="4"><el-form-item label="姓名">
                <el-input v-model="doctorName" :disabled="doctorNameDisabled"></el-input>
            </el-form-item></el-col>

            <el-form-item label="联系电话"><el-col :span="4">
                <el-input v-model="phoneNo" :disabled="phoneNoDisabled"></el-input>
            </el-col></el-form-item>

            <el-col :span="3"><el-form-item label="医生账户">
                <el-input v-model="daccountNo" :disabled="daccountDisabled"></el-input>
            </el-form-item></el-col>

            <el-col :span="3"><el-form-item label="医生编号">
                <el-input v-model="doctorID" :disabled="doctorIDDisabled"></el-input>
            </el-form-item></el-col>

            <el-form-item label="科室编号"><el-col :span="2">
                <el-input v-model="departmentNo" :disabled="departmentNoDisabled"></el-input>
            </el-col></el-form-item>

            <el-form-item label="性别"><el-col :span="4">
